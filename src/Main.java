...
public class Main {
    public static void main(String[] args) {
        ...
        Dueno duenio1 = new Dueno("Luis","0123456789",30, 'M');
        ...
        auto1.setDueno(duenio1);
        auto1.getDueno().mostrarDatosDuenio();

        System.out.println("---------------------------------------------------------");

        Dueno duenio2 = new Dueno("Juan","9874563210",40,'M');
        Motor motor2 = new Motor(4.0,"Diesel");


        Auto auto2 = new Auto(4,"Rojo",3,motor2,duenio2);
        auto2.imprimirColorPuertas(2);
        auto2.getDueno().mostrarDatosDuenio();
        ...
        Dueno duenio3 = new Dueno(nombre,cedula,edad,genero);
        ...
        auto3.getDueno().mostrarDatosDuenio();
    }
}